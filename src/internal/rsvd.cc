...
void rsvd(
    ...
    bool truncated_svd, int64_t fixed_rk) {
    using blas::conj;
...
void rsvd(
    ...
    CompressedTile<float>& C, bool use_trmm, bool use_ungqr,
    bool truncated_svd, int64_t fixed_rk);
template
void rsvd(
    double beta, double const* AU, double const* AV, int64_t ldau, int64_t Ark,
    CompressedTile<double>& C, bool use_trmm, bool use_ungqr,
    bool truncated_svd, int64_t fixed_rk);
template
void rsvd(
    std::complex<float> beta, std::complex<float> const* AU, std::complex<float> const* AV, int64_t ldau, int64_t Ark,
    CompressedTile<std::complex<float>>& C, bool use_trmm, bool use_ungqr,
    bool truncated_svd, int64_t fixed_rk);
template
void rsvd(
    std::complex<double> beta, std::complex<double> const* AU, std::complex<double> const* AV, int64_t ldau, int64_t Ark,
    CompressedTile<std::complex<double>>& C, bool use_trmm, bool use_ungqr,
    bool truncated_svd, int64_t fixed_rk);
